            ...
            <>
              {user ? (
                <div className="relative" ref={dropdownRef}>
                  ...
                  <div
                    className={`absolute right-0 top-full mt-3 w-44 bg-white border border-gray-200 rounded-lg shadow-lg p-3 text-sm transition-all duration-200
                    ${
                      open
                  ...
                  >
                    ...
                    <Link
                      href="/account"
                      className="block py-1.5 rounded hover:bg-gray-100 text-center"
                    >
                      My Account
                    </Link>
                    ...
                    <button
                      onClick={logout}
                      className="w-full py-1.5 rounded text-red-500 hover:bg-red-50 text-center"
                    >
                      Logout
                    </button>
                  </div>
